...
import "slick-carousel/slick/slick.css"; // where 
import "slick-carousel/slick/slick-theme.css";// where  
...
const Carousel = (props) => {
    console.log("props carousel",props); //lg xl md sm xs
    ...
    console.log("isShowModalVideoMovie",isShowModalVideoMovie);
    ...
    const renderCarousel = useCallback(() => {
        if (listMovies[0].length !== 0) {
            return listMovies[0].slice(0, 8).map((item, index) => {
                return (
    ...
    const renderListTheater = useCallback(() => {
        let listTheater = [];
        // console.log("theatre",propMovie.movieInfoSystem.heThongRapChieu);
    ...
    const renderListDate = useCallback(() => {
        ...
        for (let item of theater.lichChieuPhim) {
            // console.log("date",item.ngayChieuGioChieu);
