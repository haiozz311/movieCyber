...
const GroupCine = (props) => {
    console.log("props cinema",props)
    ...
    const listRapT = useSelector((state) => {
        return state.qlTheaterSystem.theaterSystemInfo.listCumRap
    });
    console.log("listRapT",listRapT);
    ...
    console.log("lstMovieWithDate 111",lstMovieWithDate);
                    ...
                    >
                        <div className={`${classes.tabRapPhimItem} `}>
                            <div className={classes.divRapImg}>
                                ...
                                <img src={item.hinhAnh} alt={returnIconTheader(item.tenCumRap.trim().slice(0, item.tenCumRap.trim().indexOf(' ')))} className={classes.movieTheaterImg} />
                            </div>
    ...
    const handleChooseDay = useCallback((value) => () => {
        console.log("listDay chose",value)
    ...
    const renderListPhim = useCallback(() => {
        if (lstMovieWithDate) {
            console.log("lstMovieWithDate",lstMovieWithDate)
